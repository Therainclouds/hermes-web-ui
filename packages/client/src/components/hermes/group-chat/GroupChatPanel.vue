...
import type { MemberInfo, RoomAgent, RoomInfo, RoomSummaryAnchor, RoomSummaryConfig, RoomSummaryState, GroupDocumentInfo, GroupChatMention } from '@/api/hermes/group-chat'
...
const roomContextMenuOptions = computed<DropdownOption[]>(() => {
    ...
    if (canManageRoom(contextRoom.value)) {
        ...
        options.push({ label: t('groupChat.exportRoomJson'), key: 'export-json' })
        options.push({ label: t('groupChat.exportRoomTxt'), key: 'export-txt' })
    }
    return options
})
...
<template>
    <div class="group-chat-panel">
        ...
        <div
            class="chat-main"
            :class="{ 'chat-main--drop-active': isChatDropActive, 'chat-main--sidebar-collapsed': !showSidebar }"
