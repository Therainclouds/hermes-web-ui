????????????export default {
  ...
  mcp: {
    ...
    toolsMode: 'Modus:',
    toolsModeAll: 'Alle',
    toolsModeInclude: 'Einschlie?en',
    toolsModeExclude: 'Ausschlie?en',
    ...
    toolsSummaryInclude: '{total} Tools insgesamt, {count} ausgew?hlt',
    toolsSummaryExclude: '{total} Tools insgesamt, {count} ausgeschlossen',
    toolsVisibilitySaved: 'Tools-Sichtbarkeit gespeichert',
    toolsSelectAll: 'Alle ausw?hlen',
    toolsClearSelection: 'Auswahl l?schen',
    toolsExcludeAll: 'Alle ausschlie?en',
    toolsClearExcluded: 'Ausschlüsse l?schen',
  },
  ...
  runtimeVersions: {
    ...
    github: 'GitHub',
    cf: 'Cloudflare',
    useVersion: 'Beim n?chsten Neustart verwenden',
    deleteVersion: 'L?schen',
    deleteRuntimeConfirm: 'Hermes Runtime {version} l?schen?',
    deleteWebUiConfirm: 'Web UI {version} l?schen?',
    deleteRuntimeSuccess: 'Runtime gel?scht',
    deleteWebUiSuccess: 'Web UI gel?scht',
    refresh: 'Aktualisieren',
    ...
    jobStage: {
      queued: 'In Warteschlange',
      download: 'Wird heruntergeladen',
      resolveRuntime: 'Runtime-Paket wird aufgel?st',
      ...
      resolveWebUi: 'Web-UI-Paket wird aufgel?st',
  ...
  devices: {
    ...
    never: 'Nie',
    unknown: 'Unbekannt',
    loadFailed: 'Ger?te konnten nicht geladen werden',
    scanFailed: 'Ger?tescan fehlgeschlagen',
    updateFailed: 'Ger?t konnte nicht aktualisiert werden',
    ...
    deleteHistory: 'Eintrag l?schen',
    deleteHistoryConfirm: 'Diesen Anfrageeintrag l?schen und den Verbindungszugriff dieses Ger?ts widerrufen?',
    requests: 'Anfragen',
  ...
  chat: {
    ...
    contextClickToEdit: 'Klicken zum Bearbeiten der Kontextl?nge',
    contextEditTitle: 'Kontextl?nge bearbeiten',
    contextEditDesc: 'Kontextl?ngenlimit für aktuelles Modell festlegen (in Tokens)',
    contextEditPlaceholder: 'Kontextl?nge eingeben',
    contextEditHint: 'H?ufige Werte: 256k (Hermes-Standard), 128k (GPT-4), 32k (GPT-3.5)',
    contextEditSave: 'Speichern',
    contextEditCancel: 'Abbrechen',
    contextEditInvalid: 'Bitte geben Sie eine gültige Kontextl?nge ein',
    contextEditSuccess: 'Kontextl?nge aktualisiert',
    ...
    slashCommands: {
      ...
      clearHistory: 'Gespeicherten Nachrichtenverlauf dieser Sitzung l?schen',
    ...
    clarifyKicker: 'Agent ben?tigt Kl?rung',
    clarifyTitle: 'Der Agent hat eine Frage an Sie',
    clarifyPlaceholder: 'Geben Sie Ihre Antwort ein...',
    clarifySubmit: 'Antworten',
    clarifyDismiss: 'Schlie?en',
    deleteSession: 'Diese Sitzung loschen?',
    toggleBatchMode: 'Batch-Auswahl',
    selectAll: 'Alle ausw?hlen',
    confirmBatchDelete: '{count} ausgew?hlte Sitzungen l?schen?',
    batchDeleteSuccess: '{count} Sitzungen gel?scht',
    batchDeletePartial: '{failed} Sitzungen konnten nicht gel?scht werden',
    batchDeleteFailed: 'Batch-L?schung fehlgeschlagen',
    ...
    openSessionInNewTab: 'In neuem Tab ?ffnen',
    sessionLinkCopied: 'Session link copied',
    copySessionId: 'Sitzungs-ID kopieren',
    export: 'Exportieren',
    exportFull: 'Vollst?ndiger Export (JSON)',
    ...
    unchangedLines: '{count} unver?nderte Zeilen',
    ...
    searchEnterHint: 'Enter zum ?ffnen · Esc zum Schlie?en',
    ...
    folderPickerSelected: 'Ausgew?hlt:',
  ...
  jobs: {
    ...
    skills: 'Skills',
    skillsPlaceholder: 'Skills ausw?hlen...',
...
jobTriggered: 'Job ausgelost',
    ...
    action: {
      ...
      triggerImmediately: 'Sofort ausl?sen',
    },
    runHistory: {
      title: 'Verlauf',
      runs: 'L?ufe',
  ...
  skills: {
    ...
    delete: 'L?schen',
    deleteConfirm: 'Skill "{name}" l?schen? Dies kann nicht rückg?ngig gemacht werden.',
    deleteSuccess: 'Skill gel?scht',
    deleteFailed: 'L?schen fehlgeschlagen',
    import: 'Importieren',
    importTitle: 'Skill importieren',
    importModeZip: 'Zip',
    importModeFolder: 'Ordner',
    importHintZip: 'Lade ein .zip-Archiv mit einem Verzeichnis hoch, das SKILL.md enth?lt',
    importHintFolder: 'W?hle einen lokalen Skill-Ordner (muss SKILL.md enthalten)',
    importTargetCategory: 'Zielkategorie (optional)',
    importTargetCategoryPlaceholder: 'Leer lassen, um unter misc abzulegen',
    importSelectFile: '.zip-Datei w?hlen',
    importSelectFolder: 'Ordner w?hlen',
    importInvalidFile: 'Nur .zip-Archive werden unterstützt',
    importFileCount: 'Dateien',
    importNoSelection: 'Bitte zuerst Datei oder Ordner w?hlen',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Aktualisieren',
    notice: 'Schreibgeschütztes Inventar erkennbarer QuantHermes-Plugin-Manifeste. Discovery-Metadaten werden gelesen, ohne Plugin-Code zu laden. Verwaltungsaktionen bleiben in v1 im CLI; ?nderungen gelten für neue QuantHermes-Sitzungen.',
  ...
  models: {
    ...
    selectOrInput: 'Modell ausw?hlen oder eingeben...',
    ...
    codexOpenLink: 'Autorisierungsseite ?ffnen',
    ...
    nousOpenLink: 'Autorisierungsseite ?ffnen',
    ...
    copilotWaiting: '?ffnen Sie GitHub und geben Sie den unten angezeigten Ger?tecode ein. Das Fenster schlie?t sich automatisch nach Genehmigung.',
    copilotCopyCode: 'Code kopiert',
    copilotOpenLink: 'GitHub-Autorisierungsseite ?ffnen',
    ...
    copilotDeleteHintEnv: 'Dies l?scht COPILOT_GITHUB_TOKEN in ~/.hermes/.env. Andere Tools sind nicht betroffen.',
    ...
    clearVisibleModels: 'Auswahl l?schen',
    ...
    xaiWaiting: 'Schlie?en Sie die Autorisierung auf der ge?ffneten xAI-Seite ab. Das Fenster schlie?t sich nach der Freigabe automatisch.',
    xaiOpenLink: 'xAI-Autorisierungsseite ?ffnen',
    ...
    anthropicWaiting: 'Schlie?en Sie die Autorisierung auf der Claude-Seite ab und fügen Sie den zurückgegebenen Code hier ein.',
    anthropicOpenLink: 'Claude-Autorisierungsseite ?ffnen',
    ...
    geminiWaiting: 'Schlie?en Sie die Autorisierung auf der ge?ffneten Google-Seite ab. Das Fenster schlie?t sich automatisch.',
    geminiOpenLink: 'Google-Autorisierungsseite ?ffnen',
    ...
    visibilityHint: 'Wirkt sich nur auf Modellauswahl und Modellseite der Web UI aus. Die provider/model-Konfiguration der Hermes CLI wird nicht ge?ndert; Aufrufe verwenden weiterhin die ursprüngliche Modell-ID.',
    ...
    aliasHint: '?ndert nur den Anzeigenamen in der Web UI. Hermes erh?lt weiterhin die ursprüngliche Modell-ID.',
  ...
  profiles: {
    ...
    avatar: {
      ...
      random: 'Zuf?llig erzeugen',
      reset: 'Standard wiederherstellen',
      hint: 'PNG, JPEG oder WebP, maximal 1 MB',
      invalidType: 'Bitte ein PNG-, JPEG- oder WebP-Bild w?hlen',
      tooLarge: 'Das Avatar-Bild darf h?chstens 1 MB gro? sein',
  ...
  settings: {
    ...
    compression: {
      ...
      targetRatioHint: 'Zielgro?e des Verlaufs nach der Komprimierung als Kontextverhaltnis',
    ...
    session: {
      ...
      humanOnlyHint: 'Unteragenten- und Sitzungsmonitor-Rauschen standardm??ig ausblenden',
      liveMonitorHumanOnly: 'Live-Monitor: nur menschliche Sitzungen anzeigen',
      liveMonitorHumanOnlyHint: 'Im Live-Monitor Unteragenten- und Sitzungsmonitor-Rauschen standardm??ig ausblenden',
      atHourHint: 'Sitzung taglich zu dieser Stunde zurucksetzen',
      requireAuth: 'Sitzungsautorisierung',
      requireAuthHint: 'Erfordert Autorisierung für Sitzungsvorg?nge',
    ...
    voice: {
      ...
      storedBaseUrlsHint: 'Gespeicherte Voice-Provider-Endpoints. Die Felder oben l?schen nur den aktuellen Wert; gespeicherte URLs hier l?schen.',
      storedBaseUrlsEmpty: 'Keine benutzerdefinierten Voice Base URLs auf dem Server gespeichert.',
      storedBaseUrlDelete: 'URL l?schen',
      storedApiKeysTitle: 'Gespeicherte API keys',
      storedApiKeysHint: 'Maskierte Liste der serverseitig gespeicherten Voice-API-Keys. Es werden nur Nutzung und Quelle angezeigt; der vollst?ndige key nie.',
      ...
      storedApiKeyDelete: 'Key l?schen',
      baseUrlPresetClear: 'URL l?schen',
      baseUrlPresetCleared: 'Base-URL aus dem Feld gel?scht.',
      baseUrlPresetDelete: 'URL l?schen',
      ...
      edgePitch: 'Tonh?he',
      edgePitchHint: 'Tonh?he anpassen (-20 ~ +20 Hz)',
      ...
      mimoAuthModeHint: 'Header-Format, das der ausgew?hlte MiMo-Endpunkt erwartet',
      ...
      mimoCloneAudioUpload: 'Datei ausw?hlen',
      mimoCloneAudioClear: 'L?schen',
    ...
    userAvatar: {
      ...
      upload: 'Bild hochladen',
      random: 'Zuf?llig generieren',
      reset: 'Auf Standard zurücksetzen',
      hint: 'Unterstützt PNG, JPEG und WebP bis 1 MB; wird automatisch auf unter 500 KB komprimiert.',
      invalidType: 'Bitte w?hlen Sie ein PNG-, JPEG- oder WebP-Bild aus',
      tooLarge: 'Das Avatarbild darf h?chstens 1 MB gro? sein',
      saveSuccess: 'Avatar gespeichert',
      saveFailed: 'Avatar konnte nicht gespeichert werden',
  ...
  githubPreview: {
    ...
    description: "Klont den ausgew?hlten GitHub-Tag in den Web-UI-Vorschaubereich, installiert Abh?ngigkeiten und startet ihn mit den Entwicklungsports.",
    refresh: "Aktualisieren",
    ...
    stop: "Stoppen",
    note: "Der Vorschaucode wird im Web-UI-Datenverzeichnis gespeichert. Produktion bleibt auf Port 6060; die Vorschau nutzt Frontend 8651 und Backend 8650.",
    path: "Vorschaupfad",
    webuiHome: "Vorschau-Datenverzeichnis",
    currentTag: "Aktueller Tag",
    repoReady: "Repository bereit",
    dependencies: "Abh?ngigkeiten installiert",
    running: "Status",
    ...
    installSuccess: "Abh?ngigkeiten installiert",
  ...
  platform: {
    ...
    exclusiveTokenWarning: 'Diese Plattform verwendet einen exklusiven Token-Lock. Jedes Profil muss einen anderen Identit?ts-Token verwenden, um Konflikte mit anderen Profilen zu vermeiden.',
    botToken: 'Bot-Token',
    ...
    qqQrScanHint: 'QR-Code oben mit QQ scannen oder Link auf dem Telefon ?ffnen, um die Bindung abzuschlie?en',
    qqMarkdownHint: 'Markdown-formatierte Nachrichten aktivieren (einige Clients unterstützen dies m?glicherweise nicht)',
  ...
  skillsUsage: {
    title: 'Skill-Nutzung',
    subtitle: 'Skill-Ladevorg?nge und -Bearbeitungen aus QuantHermes-Sitzungen verfolgen',
    refresh: 'Aktualisieren',
  ...
  changelog: {
    ...
    new_0_6_14_8: 'Geraetekopplung ist sicherer mit Start-Pairing-Code, Freigabe vor Anfragen, Anfrage-Drosselung und unveraenderter LAN-Erkennung fuer vertrauenswuerdige lokale Abl?ufe',
    ...
    new_0_6_12_2: 'Claude Code und Codex starten in der Windows-Desktop-App verlaesslicher, mit korrigierter Befehlsaufl?sung und besser lesbaren Fehlermeldungen',
    new_0_6_12_3: 'Reasoning, Warteschlangenstatus und Fehlerzust?nde von Coding Agent sind leichter nachzuvollziehen, mit gespeicherten Reasoning-Inhalten und einer Warteschlangenanzeige, die das Scrollen nicht blockiert',
    new_0_6_12_4: 'Die Versionsverwaltung der Desktop-Laufzeit unterstützt Coding-Agent-Abl?ufe mit Wechsel der aktiven Version, Versionsliste der Website, Release-Paketierung und Anzeige nur in der Desktop-App',
    ...
    new_0_6_12_6: 'Der Gruppenchat ist stabiler: Die Mention-Position nach Gr??en?nderungen wurde korrigiert und Uploads folgen dem aktiven Profile',
    ...
    new_0_6_12_8: 'Das Koppeln entfernter Ger?te ist einfacher, mit manueller Kopplung und LAN-HTTP-Fallback',
    new_0_6_12_9: 'Die Chat-Anzeige wurde verbessert: Hervorgehobene Codebl?cke mit langen ununterbrochenen Zeichenfolgen laufen nicht mehr aus dem Bildschirm; Diff-Bl?cke behalten horizontales Scrollen fuer Zeilenausrichtung',
    new_0_6_12_10: 'Weitere Frontend-Verbesserungen umfassen Fallback beim Koppeln entfernter Ger?te, klarere Sidebar-Texte, bessere Benutzeranzeige beim Logout und das Entfernen der nicht angeschlossenen Busy-Input-Einstellung',
    new_0_6_11_1: 'Die LAN-Ger?teerkennung umfasst jetzt Kopplungsfreigaben, Antragsverlauf, Behandlung doppelter Anfragen, Statussynchronisierung und Bereinigung beim Entzug des Ger?tezugriffs',
    ...
    new_0_6_11_6: 'Agent Bridge und Laufzeitabl?ufe sind zuverl?ssiger durch Behandlung von Abbruch-Timeouts, Startschutz beim Fortsetzen, gespeicherte execute-code-Freigaben, Windows-Gateway-Wiederherstellung und Korrekturen am Entwicklungs-Terminal-Proxy',
    new_0_6_11_7: 'Die Sicherheit wurde durch Web-UI-Origin-Policy, Sicherheitsheader und Zugriffsschutz fuer server token über die lokale Loopback-Schnittstelle verst?rkt',
    ...
    new_0_6_11_9: 'Skills und Workspace unterstützen jetzt externe Skill-Verzeichnisse, Aktualisierung nach Import oder L?schen, Gruppierung nach sourcePath, übersetzte Ordnerauswahltexte und mobile Skill-Aktionssymbole',
    new_0_6_11_10: 'Ger?telayout, Sitzungstitel, Browser-Tab-Titel, übergeordnete Kanban-Aufgaben-IDs und OpenRouter-Zuordnungstexte wurden verbessert',
  ...
  groupChat: {
    ...
    selectRoomFirst: 'Bitte w?hlen Sie zuerst einen Raum',
    ...
    roomDeleted: 'Raum gel?scht',
    roomCloned: 'Raum geklont',
    cloneRoom: 'Raum klonen',
    copyRoomLink: 'Raumlink kopieren',
    deleteRoomConfirm: 'Diesen Raum l?schen?',
    clearContext: 'Kontext l?schen',
    clearContextConfirm: 'Diesen Raumkontext l?schen? Nachrichten und Komprimierungs-Snapshots werden entfernt, Agenten und Mitglieder bleiben.',
    contextCleared: 'Kontext gel?scht',
    exportRoomJson: 'Als JSON exportieren',
    exportRoomTxt: 'Als TXT exportieren',
    exportAll: 'Alle R?ume exportieren',
    ...
    importSuccess: '{count} Raum/R?ume erfolgreich importiert',
    ...
    tailMessageCountDesc: 'Anzahl der letzten Nachrichten, die unver?ndert bleiben',
    compressionConfig: 'Komprimierungskonfig',
    compressNow: 'Jetzt komprimieren',
    compressingInProgress: 'Komprimierung l?uft, bitte warten',
  ...
  kanban: {
    ...
    form: {
      ...
      selectAssignee: 'Verantwortlichen w?hlen...',
      priority: 'Priorit?t',
      selectPriority: 'Priorit?t w?hlen...',
      tenant: 'Mandant',
      tenantPlaceholder: 'Mandant (optional)',
      workspace: 'Workspace',
      workspaceScratch: 'Tempor?rer Workspace',
    ...
    detail: {
      ...
      sessions: 'Zugeh?rige Sitzungen',
      sessionMessages: 'Sitzungsnachrichten',
      noSessions: 'Keine zugeh?rigen Sitzungen gefunden.',
    ...
    message: {
      ...
      dispatchNudged: 'Dispatcher angesto?en',
