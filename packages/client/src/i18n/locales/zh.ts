export default {
  ...
  changelog: {
    ...
    new_0_6_30_1: '修复 source-deploy 与 device-package 的托管更新在 detached runner 正常结束后仍停留在 running 状态的问题，成功交接后会明确标记为 succeeded',
    new_0_6_30_2: '新增安全的 Web UI 清理入口，可清除已结束但过期的更新失败记录，避免旧错误长期让侧边栏停留在红色失败状态',
