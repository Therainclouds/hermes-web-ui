????????export default {
  ...
  chat: {
    ...
    openSessionInNewTab: 'Abrir en una nueva pesta?a',
...
jobTriggered: 'Job ejecutado',
  ...
  settings: {
    ...
    voice: {
      ...
      mimoHint: 'Xiaomi MiMo TTS — voces predefinidas, dise?o de voz y clonación de voz',
      ...
      mimoModelVoiceDesign: 'Dise?o de voz',
  ...
  githubPreview: {
    ...
    stop: "Detener",
    note: "El código de vista previa se guarda bajo el directorio de datos de Web UI. Producción sigue en el puerto 6060; la vista previa usa frontend 8651 y backend 8650.",
