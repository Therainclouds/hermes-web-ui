export default {
  ...
  login: {
    ...
    unbindDevice: '기기 연결 해제',
    unbindDeviceConfirm: '{account}에 연결된 기기를 해제하시겠습니까?',
    unbindDeviceSuccess: '기기 연결이 해제되었습니다',
    unbindDeviceFailed: '기기 연결 해제에 실패했습니다',
    or: '또는',
    passwordOption: '또는 비밀번호로 로그인',
    back: '뒤로',
    wechatLogin: 'WeChat 스캔 로그인',
    wechatLoginTitle: 'WeChat으로 스캔',
    wechatQrLoading: 'QR 코드 불러오는 중…',
    wechatQrHint: 'WeChat으로 스캔하여 Token Platform 계정을 연결하고 모델을 동기화하세요.',
    wechatQrWaiting: '스캔 대기 중…',
    wechatQrExpired: 'QR 코드 만료',
    wechatQrRefresh: 'QR 새로고침',
    wechatQrFailed: 'QR 코드를 불러오지 못했습니다',
    wechatQrOpenedHint: 'WeChat 로그인 페이지가 새 탭에서 열렸습니다. QR 코드를 WeChat으로 스캔하세요.',
    wechatQrOpenPage: 'WeChat 로그인 페이지 열기',
    wechatQrPopupBlocked: '팝업이 차단되었습니다. 버튼을 클릭하여 WeChat 로그인 페이지를 여세요.',
    deviceLoginSyncing: '모델과 계정 동기화 중…',
  ...
  omniRealtime: {
    ...
    limitsBanner: '{model} 의 세션 한도는 {parts} 입니다. 초과하면 이전 턴은 사라집니다.',
    limitsAudioTurns: '오디오 {count}턴',
    limitsVideoTurns: '비디오 {count}턴',
    limitsAudioSeconds: '오디오 {seconds}초(약 {minutes}분)',
    modelPickerLabel: '모델',
    modelFlash: 'Flash · 더 빠름',
    modelPlus: 'Plus · 더 똑똑함',
  ...
  speechPractice: {
    ...
    direction: '연습 주제',
    directionPlaceholder: '예: IELTS 스피킹 Part 2, 취업 면접 자기소개, 카페에서 주문하기… (비워 두면 자유 대화)',
    difficulty: '난이도',
    diffBeginner: '입문',
    diffIntermediate: '중급',
    diffAdvanced: '고급',
    startSession: '연습 시작',
    title: '말하기 연습',
    subtitle: 'AI 스피킹 코치 · 매 턴 코멘트와 채점 · 분석 보고서 자동 생성',
    setupHint: '준비되면 "연습 시작"을 누르세요. 매 턴 말한 뒤 코치가 구두로 코멘트하고 채점하며, 종료 후 전체 분석을 Markdown 보고서로 저장할 수 있습니다.',
    back: '뒤로',
    endSession: '연습 종료',
    liveHint: '연습 중: 바로 말해 보세요',
    handsFreeHint: '핸즈프리 모드: 그냥 말하면 코치가 매 턴 발언 후 코멘트와 채점을 해 줍니다',
    resume: '연습 계속하기',
    close: '채팅으로 돌아가기',
    scoringRunning: '코치가 이번 턴을 채점하는 중 …',
    scoringDone: '이번 턴의 채점이 기록되었습니다',
    scoringFailed: '이번 턴의 채점 기록에 실패했습니다',
    scoredRound: '{n}번째 턴의 채점이 기록되었습니다',
    scoredUnattached: '추가 채점이 기록되었습니다',
    scoredOverall: '총점 {score}/10',
    scoredNoOverall: '총점이 없습니다',
    scoreBoard: '턴별 채점',
    scoresEmpty: '연습을 시작하면 코치가 각 턴 말하기가 끝날 때 채점과 코멘트를 제공합니다',
    roundLabel: '{n}번째 턴',
    unattachedRound: '추가 채점',
    score: {
      overall: '총점',
      fluency: '유창성',
      pronunciation: '발음·억양',
    ...
    example: '더 자연스러운 표현',
    endedTitle: '연습 완료',
    endedSummary: '사용자 발언 {user}턴 · 코치 답변 {assistant}턴 · 기록된 채점 {scored}개',
    avgOverall: '전체 평균',
    tableDimension: '항목',
    tableAvg: '평균',
    tableMax: '최고',
    tableMin: '최저',
    noFeedback: '이번 연습에는 아직 채점이 없습니다',
    saveReport: '분석 보고서 저장 (.md)',
  ...
  models: {
    ...
    realtimeSubtitle: '실시간 음성 대화에 사용할 Qwen(DashScope) 모델을 설정합니다. 여기에 저장한 API 키는 공통 기본값으로, 회의 모드 ASR과 Realtime 대화가 DashScope 키를 별도로 설정하지 않았을 때 사용됩니다.',
  ...
  profiles: {
    ...
    displayNameHint: '표시 이름은 UI에만 영향, 요청은 시스템 이름을 사용',
    displayNameClearHint: '비워두면 시스템 이름으로 복원됩니다',
    displayNameSaveFailed: '표시 이름 업데이트 실패',
    displayNameSaveSuccess: '표시 이름이 업데이트되었습니다',
    editDisplayName: '표시 이름 편집',
    displayNamePlaceholder: '예: 회의 도우미',
  ...
  groupChat: {
    ...
    discussion: {
      title: '자유 토론',
      desc: '방 안의 여러 에이전트가 목표를 두고 차례로 발언하며 자유롭게 토론하고, AI 심판이 합의를 판정하여 통일된 의견 보고서를 자동 생성합니다.',
      start: '자유 토론 시작',
      startFailed: '토론 시작 실패',
      stop: '토론 중지',
      stopFailed: '토론 중지 실패',
      inProgress: '토론 진행 중',
      round: '{current}/{max} 라운드',
      needsAgents: '토론을 시작하려면 방에 최소 2명의 에이전트가 필요합니다',
      goal: '토론 목표',
      goalPlaceholder: '방 안 에이전트들이 함께 논의하고 해결할 문제를 입력하세요…',
      agentOrder: '발언 순서',
      agentOrderPlaceholder: '토론에 참여할 에이전트 선택',
      agentOrderDesc: '선택한 순서대로 차례로 발언합니다. 미선택 시 모든 에이전트',
      reporter: '보고 에이전트',
      maxRounds: '최대 라운드',
      maxMessages: '메시지 상한',

      minRounds: '최소 라운드',
      longRun: '장시간 작업 모드(무인 야간 실행)',
      longRunHint: '장시간 실행 사전 설정(40라운드/최소 15라운드/600메시지)을 적용하고 안전장치(단계 분할, 단계별 산출물 저장, 완료 기준, 사용자 질문 금지)를 자동 추가합니다. 작업 목표와 자료 경로만 입력하면 됩니다.',
      judgeDesc: '심판 모델은 기본적으로 방 요약 설정을 따릅니다',
      roundsDone: '{rounds}라운드 완료',
      convergedLabel: '합의 도달',
      quickStartButton: '토론 시작',
      quickStartTitle: '자유 토론 시작',
      quickStartGoal: '토론 목표',
      quickStartGoalPlaceholder: '방 안의 agent들이 함께 논의하고 해결할 문제를 설명하세요…',
      quickStartParticipants: '참여 Agent',
      quickStartHint: '팁: 입력란에서 /discuss <목표> [{\'@\'}멤버] 를 보내 시작할 수 있습니다. "long-run"을 추가하면 무인 야간 모드가 활성화됩니다',
      quickStartStart: '시작',
      managerOnly: '방장만 토론을 시작할 수 있습니다',
      ...
      downloadDuringActive: '토론이 진행 중입니다. 종료 후 다운로드할 수 있습니다',
      downloadFailed: '보고서 다운로드 실패',
      docTitle: '그룹 토론 보고서',
      docMetaLabel: '토론 정보',
      docStatusLabel: '종료 상태',
      docRoundsLabel: '진행 라운드',
      docAgentsLabel: '참여 Agent',
      docJudgeLabel: '라운드별 판정',
      docReportLabel: '통합 의견 보고서',
      docRoundLabel: '{round}라운드',
      docStalledLabel: '정체',
      docProgressLabel: '진전 있음',
      docAssessmentLabel: '평가',
      docSuggestionLabel: '제안',
      docGeneratedBy: 'Hermes Studio 그룹 토론에서 자동 생성됨',
      docJudgeMissingLabel: '이번 토론의 심판 평가가 누락되었습니다',
      status: {
        pending: '시작 대기',
        running: '진행 중',
        paused: '일시 중지',
  ...
  changelog: {
    ...
    new_0_6_20_6: 'ESP32는 tutorial link 업데이트와 Windows 호환 flow animation을 개선했습니다',
