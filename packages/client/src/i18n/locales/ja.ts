export default {
  ...
  login: {
    ...
    unbindDevice: 'デバイスの紐付け解除',
    unbindDeviceConfirm: '{account} に紐付けられたデバイスを解除してもよろしいですか？',
    unbindDeviceSuccess: 'デバイスの紐付けを解除しました',
    unbindDeviceFailed: 'デバイスの紐付け解除に失敗しました',
    or: 'または',
    passwordOption: 'またはパスワードでログイン',
    back: '戻る',
    wechatLogin: 'WeChat スキャンログイン',
    wechatLoginTitle: 'WeChat でスキャン',
    wechatQrLoading: 'QRコードを読み込み中…',
    wechatQrHint: 'WeChat でスキャンして Token Platform アカウントを紐付け、モデルを同期します。',
    wechatQrWaiting: 'スキャン待ち…',
    wechatQrExpired: 'QRコードの有効期限が切れました',
    wechatQrRefresh: 'QRを更新',
    wechatQrFailed: 'QRコードを読み込めませんでした',
    wechatQrOpenedHint: 'WeChat のログインページを新しいタブで開きました。表示された QR コードを WeChat でスキャンしてください。',
    wechatQrOpenPage: 'WeChat ログインページを開く',
    wechatQrPopupBlocked: 'ポップアップがブロックされました。ボタンをクリックして WeChat ログインページを開いてください。',
    deviceLoginSyncing: 'モデルとアカウントを同期中…',
  ...
  omniRealtime: {
    ...
    limitsBanner: '{model} のセッション上限は {parts} です。超過すると古いターンは失われます。',
    limitsAudioTurns: '音声ターン {count} 回',
    limitsVideoTurns: '映像ターン {count} 回',
    limitsAudioSeconds: '音声 {seconds} 秒（約 {minutes} 分）',
    modelPickerLabel: 'モデル',
    modelFlash: 'Flash · より高速',
    modelPlus: 'Plus · より賢い',
  ...
  speechPractice: {
    ...
    direction: '練習テーマ',
    directionPlaceholder: '例：IELTS スピーキング Part 2、就職面接の自己紹介、カフェで注文…（空欄なら自由会話）',
    difficulty: '難易度',
    diffBeginner: '初級',
    diffIntermediate: '中級',
    diffAdvanced: '上級',
    startSession: '練習を開始',
    title: 'スピーキング練習',
    subtitle: 'AI スピーキングコーチ · 毎ターン講評と採点 · 分析レポートを自動作成',
    setupHint: '準備ができたら「練習を開始」を押してください。毎ターンの発言後、コーチが口頭で講評して採点します。終了後は全体の分析を Markdown レポートとして保存できます。',
    back: '戻る',
    endSession: '練習を終了',
    liveHint: '練習中：そのまま話し始めてください',
    handsFreeHint: 'ハンズフリーモード：話すだけで、コーチが毎ターンの発言後に講評・採点します',
    resume: '練習を再開',
    close: 'チャットに戻る',
    scoringRunning: 'コーチがこのターンを採点しています …',
    scoringDone: 'このターンの採点を記録しました',
    scoringFailed: 'このターンの採点の記録に失敗しました',
    scoredRound: '第 {n} ターンの採点を記録しました',
    scoredUnattached: '追加の採点を記録しました',
    scoredOverall: '合計点 {score}/10',
    scoredNoOverall: '合計点はありません',
    scoreBoard: 'ターンごとの採点',
    scoresEmpty: '練習を始めると、コーチが各ターンの発言終了時に採点と講評を行います',
    roundLabel: '第 {n} ターン',
    unattachedRound: '追加の採点',
    score: {
      overall: '合計点',
      fluency: '流暢さ',
      pronunciation: '発音・イントネーション',
      grammar: '文法',
      vocabulary: '語彙',
      content: '内容・論理性',
    ...
    example: 'より自然な言い回し',
    endedTitle: '練習終了',
    endedSummary: 'ユーザーの発言 {user} ターン · コーチの返答 {assistant} ターン · 記録された採点 {scored} 件',
    avgOverall: '全体の平均',
    tableDimension: '項目',
    tableAvg: '平均',
    tableMax: '最高',
    tableMin: '最低',
    noFeedback: 'この練習ではまだ採点がありません',
    saveReport: '分析レポートを保存 (.md)',
...
// DeepSeek Harness plugin management — covers management UI strings used by
  ...
  models: {
    ...
    realtimeSubtitle: 'リアルタイム音声会話で使用する Qwen（DashScope）モデルを設定します。ここで保存した API キーは共通のデフォルトで、会議モードの ASR と Realtime 会話は DashScope キーが個別に未設定のときにこれを使います。',
    ...
    realtimeAsrProviderHint: '会議モードの音声認識で使用するプロバイダーを選択します。DashScope（既定）は Paraformer / Fun-ASR、MiniMax は MiniMax Speech-to-Text REST API を使用します。',
    realtimeAsrProviderLabel: 'ASR プロバイダー',
    realtimeAsrSectionTitle: '会議モード ASR',
    realtimeMinimaxApiKey: 'MiniMax API キー',
    realtimeMinimaxApiKeyHint: '現在のユーザープロファイル（サーバー側）に保存されます。platform.minimax.cn → インターフェースキーで作成できます。ASR プロバイダーが MiniMax の場合のみ使用されます。',
    realtimeMinimaxApiKeyPlaceholder: 'MiniMax API キーを入力',
    realtimeMinimaxBaseUrlHint: '既定は https://api.minimaxi.com（中国）。国際版は https://api.minimax.io を使用します。',
    realtimeMinimaxBaseUrlLabel: 'MiniMax API エンドポイント',
    realtimeMinimaxBaseUrlPlaceholder: 'https://api.minimaxi.com',
    realtimeMinimaxModelHint: '公式 ASR ドキュメントでは現在 asr-1.0 のみが公開されています。speech-01 は将来のモデル切替用のエイリアスです。',
    realtimeMinimaxModelLabel: 'MiniMax 認識モデル',
    realtimeMinimaxModelPlaceholder: 'asr-1.0',
    realtimeSaved: 'Realtime モデル設定を保存しました',
    realtimeSaveFailed: 'Realtime モデル設定の保存に失敗しました',
  ...
  profiles: {
    ...
    displayNameHint: '表示名はUIのみに影響し、リクエストはシステム名を使用します',
    displayNameClearHint: '空にするとシステム名に戻ります',
    displayNameSaveFailed: '表示名の更新に失敗しました',
    displayNameSaveSuccess: '表示名を更新しました',
    editDisplayName: '表示名を編集',
    displayNamePlaceholder: '例：会議アシスタント',
    displayName: '表示名（任意）',
    newName: '新しい名前',
  ...
  settings: {
    ...
    nicknameMojibakeHint: 'WeChatのニックネームが破損して見えます(モジバケ)。ログインページでWeChatを一度スキャンし直してください — システムが正しいニックネームで上書きします。',
  ...
  groupChat: {
    ...
    discussion: {
      title: 'フリー討論',
      desc: 'ルーム内の複数のエージェントが目標をめぐって順番に発言・自由討論し、AI 審判が合意を判定して統一見解レポートを自動生成します。',
      start: '討論を開始',
      startFailed: '討論の開始に失敗しました',
      stop: '討論を停止',
      stopFailed: '討論の停止に失敗しました',
      inProgress: '討論進行中',
      round: '第 {current}/{max} ラウンド',
      needsAgents: '討論を開始するにはルーム内に 2 体以上のエージェントが必要です',
      goal: '討論の目標',
      goalPlaceholder: 'ルーム内のエージェントに話し合って解決してほしい問題を記入…',
      agentOrder: '発言順',
      agentOrderPlaceholder: '討論に参加するエージェントを選択',
      agentOrderDesc: '選択した順で順番に発言します。未選択の場合は全エージェント',
      reporter: '報告エージェント',
      maxRounds: '最大ラウンド数',
      maxMessages: 'メッセージ上限',

      minRounds: '最小ラウンド数',
      longRun: '長時間タスクモード（無人での夜間実行）',
      longRunHint: '長時間実行プリセット（40ラウンド/最小15ラウンド/600メッセージ）を適用し、ガードレール（段階分割、各段階の納品ファイル保存、完了基準、ユーザーへの質問禁止）を自動付加します。タスク目標と資料パスを入力するだけです。',
      judgeDesc: '審判モデルはデフォルトでルームの要約設定に従います',
      roundsDone: '{rounds} ラウンド完了',
      convergedLabel: '合意に達しました',
      quickStartButton: '討論を開始',
      quickStartTitle: '自由討論を開始',
      quickStartGoal: '討論目標',
      quickStartGoalPlaceholder: '部屋の agent に話し合って解決してほしい問題を説明…',
      quickStartParticipants: '参加する Agent',
      quickStartHint: 'ヒント: 入力欄で /discuss <目標> [{\'@\'}メンバー] を送信して開始できます。「long-run」を追加すると無人での夜間モードが有効になります',
      quickStartStart: '開始',
      managerOnly: 'ルームオーナーのみ討論を開始できます',
      ...
      downloadDuringActive: '討論実行中です。終了後にダウンロードできます',
      downloadFailed: 'レポートのダウンロードに失敗しました',
      docTitle: 'グループ討論レポート',
      docMetaLabel: '討論情報',
      docStatusLabel: '終了状態',
      docRoundsLabel: '実施ラウンド数',
      docAgentsLabel: '参加 Agent',
      docJudgeLabel: '各ラウンドの判定',
      docReportLabel: '統一意見レポート',
      docRoundLabel: '第 {round} ラウンド',
      docStalledLabel: '停滞',
      docProgressLabel: '進展あり',
      docAssessmentLabel: '評価',
      docSuggestionLabel: '提案',
      docGeneratedBy: 'Hermes Studio グループ討論により自動生成',
      docJudgeMissingLabel: 'この討論の裁判評価がありません',
      status: {
        pending: '開始待ち',
        running: '進行中',
        paused: '一時停止',
  ...
  changelog: {
    ...
    new_0_6_20_6: 'ESP32 は tutorial link 更新、Windows 互換の flow animation を改善しました',
