export default {
  ...
  changelog: {
    ...
    new_0_6_30_1: 'Managed source-deploy and device-package updates now mark tasks succeeded when the detached runner exits cleanly, instead of leaving stale running state behind after a successful handoff',
    new_0_6_30_2: 'Added a safe Web UI action to clear stale finished update errors so old failed task records no longer keep the sidebar stuck in a red error state',
