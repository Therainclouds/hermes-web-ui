export default {
  ...
  meeting: {
    ...
    llmOptionalHint: 'AI analysis (auto meeting minutes, key points, action items) requires an LLM config. Skip if you only want to record audio.',
    ...
    wizardWarnMissingLlm: 'LLM not configured. Meeting can be recorded, but auto analysis report will not be generated.',
    ...
    hermesAgentDesc: 'Use Hermes Agent for intelligent analysis with real-time report generation',
    customModel: 'Custom Model',
    customModelDesc: 'Select a specific AI model for analysis',
