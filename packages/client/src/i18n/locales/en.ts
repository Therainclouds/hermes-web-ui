export default {
  ...
  login: {
    ...
    unbindDeviceConfirm: 'Are you sure you want to unbind the device bound to {account}?',
    unbindDeviceSuccess: 'Device unbound successfully',
    unbindDeviceFailed: 'Failed to unbind device',
    or: 'or',
    passwordOption: 'or sign in with password',
    back: 'Back',
    wechatLogin: 'WeChat Scan Login',
    wechatLoginTitle: 'Scan with WeChat',
    wechatQrLoading: 'Loading QR code…',
    wechatQrHint: 'Scan with WeChat to bind your Token Platform account and sync your models.',
    wechatQrWaiting: 'Waiting for scan…',
    wechatQrExpired: 'QR code expired',
    wechatQrRefresh: 'Refresh QR',
    wechatQrFailed: 'Failed to load QR code',
    wechatQrOpenedHint: 'The WeChat login page has been opened in a new tab. Scan the QR code there with WeChat.',
    wechatQrOpenPage: 'Open WeChat Login Page',
    wechatQrPopupBlocked: 'Popup blocked. Click the button to open the WeChat login page.',
    deviceLoginSyncing: 'Syncing models and account…',
    deviceLoginFailed: 'Device login failed',
    // WeChat bind choice modal
    choiceTitle: 'Which account to bind to?',
    choiceDesc: 'WeChat verified. Please choose your local identity to bind:',
    choiceBindSuperAdmin: 'Bind as super administrator',
    choiceCreateUser: 'Create a new local account',
    choicePickExisting: 'Pick an existing account to bind',
    choiceConfirmBind: 'Confirm bind',
    choiceFieldsRequired: 'Please fill in all required fields',
    choiceNoCandidates: 'No matching local account found. Please choose another option above',
    ...
    choiceBindByCredentials: 'Bind with account (username or phone)',
    credentialIdentifier: 'Username or phone number',
    bindByCredentialsFailed: 'Failed to bind account',
    ...
    bindSuperAdminNo: 'No, keep as regular user',
    bindSuperAdminSkipHint: 'You can keep using this device as a regular user, or bind later by re-logging in with WeChat.',
    bindSuperAdminCredentialsPrompt: 'Enter the super administrator username and password to verify and bind this WeChat account.',
    bindSuperAdminUsernamePlaceholder: 'Super administrator username',
    bindSuperAdminPasswordPlaceholder: 'Super administrator password',
    bindSuperAdminFailed: 'Failed to bind super administrator',
    ...
    recoveryClearLocksButton: 'Clear Login Lock',
    recoveryResetPasswordButton: 'Reset Default Password',
    recoveryClearLocksTitle: 'Clear Login Lock',
    recoveryResetPasswordTitle: 'Reset Default Password',
    recoveryClearLocksDescription: 'Enter the recovery password to clear all IP locks. Existing user accounts are not affected.',
    recoveryResetPasswordDescription: 'Enter the recovery password to reset the default quanthermes account back to its default password (12345678).',
    recoveryClearLocksSuccess: 'Login locks cleared',
    recoveryResetPasswordSuccess: 'Default password reset',
    recoveryPasswordPlaceholder: 'Recovery password',
    recoveryFailed: 'Recovery action failed',
  },
  ...
  sidebar: {
    ...
    updateStage: {
      ...
      resolving_version: 'Resolving target version',
      ...
      health_checking: 'Running health check',
  ...
  omniRealtime: {
    ...
    limitsBanner: '{model} caps the conversation at {parts}; longer sessions will lose earlier turns.',
    limitsAudioTurns: '{count} audio turns',
    limitsVideoTurns: '{count} video turns',
    limitsAudioSeconds: '{seconds}s ({minutes} min) of audio',
    modelPickerLabel: 'Model',
    modelFlash: 'Flash · faster',
    modelPlus: 'Plus · smarter',
  ...
  speechPractice: {
    ...
    directionPlaceholder: 'e.g. IELTS Speaking Part 2, job-interview self-introduction, ordering at a café… (empty = free conversation)',
    difficulty: 'Level',
    ...
    subtitle: 'AI speaking coach · scores every turn · generates an analysis report',
    setupHint: 'Press "Start practice" when ready. The coach scores each of your turns and you can save the full analysis as a Markdown report at the end.',
    back: 'Back',
    endSession: 'End practice',
    liveHint: 'Practicing: just start speaking',
    handsFreeHint: 'Hands-free: speak directly and the coach scores each turn',
    resume: 'Resume',
    close: 'Back to chat',
    scoringRunning: 'The coach is scoring this turn…',
    scoringDone: 'Turn score recorded',
    scoringFailed: 'Failed to record this turn score',
    scoredRound: 'Recorded score for turn {n}',
    scoredUnattached: 'Recorded extra score',
    scoredOverall: 'overall {score}/10',
    scoredNoOverall: 'no overall score given',
    scoreBoard: 'Turn scores',
    scoresEmpty: 'After you start, the coach scores each turn when you finish speaking',
    roundLabel: 'Turn {n}',
    unattachedRound: 'Extra score',
    score: {
      overall: 'Overall',
      fluency: 'Fluency',
    ...
    example: 'More natural phrasing',
    endedTitle: 'Practice ended',
    endedSummary: '{user} user turns · {assistant} coach replies · {scored} scores recorded',
    avgOverall: 'Session average',
    tableDimension: 'Dimension',
    tableAvg: 'Avg',
    tableMax: 'Max',
    tableMin: 'Min',
    noFeedback: 'No scores were recorded in this session',
    saveReport: 'Save analysis (.md)',
  ...
  chat: {
    ...
    dragDropHint: 'Drop files here to attach',
    expert: 'Expert',
    expertSwitchFailed: 'Failed to switch expert',
    startTalking: 'Start a conversation with Hermes Agent',
  },
...
// DeepSeek Harness plugin management — covers management UI strings used by
  ...
  models: {
    ...
    realtimeSubtitle: 'Configure the Qwen (DashScope) model used by realtime voice conversations. The API key saved here is a shared default: meeting-mode ASR and Realtime conversations fall back to it when no DashScope key is configured separately.',
    ...
    realtimeAsrSectionTitle: 'Meeting-mode ASR',
    realtimeMinimaxApiKey: 'MiniMax API Key',
    realtimeMinimaxApiKeyHint: 'Saved to the current user profile on the server. Create one at platform.minimax.cn → Interface Key. Only used when the ASR provider is set to MiniMax.',
    realtimeMinimaxApiKeyPlaceholder: 'Enter MiniMax API Key',
    realtimeMinimaxBaseUrlHint: 'Default https://api.minimaxi.com (China). Use https://api.minimax.io for international.',
    realtimeMinimaxBaseUrlLabel: 'MiniMax API endpoint',
    realtimeMinimaxBaseUrlPlaceholder: 'https://api.minimaxi.com',
    realtimeMinimaxModelHint: 'The official ASR docs currently expose only `asr-1.0`; `speech-01` is kept as a stable alias for future model switches.',
    realtimeMinimaxModelLabel: 'MiniMax recognition model',
    realtimeMinimaxModelPlaceholder: 'asr-1.0',
    realtimeSaved: 'Realtime model configuration saved',
    realtimeSaveFailed: 'Failed to save realtime model configuration',
  ...
  profiles: {
    ...
    unbindSuperAdmin: 'Unbind Super Administrator',
    unbindSuperAdminConfirm: 'Unbind from the super administrator? Your account will be demoted to a regular user and the default profile will revert to its original name.',
    unbindSuperAdminSuccess: 'Unbound super administrator',
    unbindSuperAdminFailed: 'Failed to unbind super administrator',
    ...
    displayNameHint: 'Display name only affects the UI; requests still use the system name',
    displayNameClearHint: 'Leave empty to restore the system name',
    displayNameSaveFailed: 'Failed to update display name',
    displayNameSaveSuccess: 'Display name updated',
    editDisplayName: 'Edit display name',
    displayNamePlaceholder: 'e.g. My meeting assistant',
  ...
  settings: {
    ...
    phone: {
      title: 'Phone Binding',
      bound: 'Bound: {phone}',
      notBound: 'No phone number bound',
      bind: 'Bind Phone',
      change: 'Change Phone',
      unbind: 'Unbind Phone',
      unbindConfirm: 'Are you sure you want to unbind this phone number?',
      inputLabel: 'Phone Number',
      placeholder: 'Enter phone number',
      hint: 'Phone number is used for identity matching during WeChat binding. A phone must be set before binding WeChat, serving as an identity fallback after WeChat unbinding.',
      required: 'Please enter a phone number',
      bindSuccess: 'Phone number bound',
      unbindSuccess: 'Phone number unbound',
    },
    tabs: {
      display: 'Display',
  ...
  groupChat: {
    ...
    exportRoomJson: 'Export as JSON',
    exportRoomTxt: 'Export as TXT',
    exportAll: 'Export all rooms',
    exportSuccess: 'Export completed',
    import: 'Import',
    selectFile: 'Select file',
    chooseFile: 'Choose file',
    importHint: 'Select a JSON file exported from group chat',
    importSuccess: '{count} room(s) imported successfully',
    importPartialSuccess: '{success} imported, {failed} failed',
    discussion: {
      title: 'Free Discussion',
      desc: 'Have multiple agents in the room take turns speaking around a goal and discuss freely; an AI judge checks consensus and automatically produces a unified opinion report.',
      start: 'Start Free Discussion',
      startFailed: 'Failed to start discussion',
      stop: 'Stop Discussion',
      stopFailed: 'Failed to stop discussion',
      inProgress: 'Discussion in progress',
      round: 'Round {current}/{max}',
      needsAgents: 'At least 2 agents are required in the room to start a discussion',
      goal: 'Discussion Goal',
      goalPlaceholder: 'Describe the problem you want the agents in the room to discuss and solve…',
      agentOrder: 'Speaking Order',
      agentOrderPlaceholder: 'Select agents to join the discussion',
      agentOrderDesc: 'Agents speak in the selected order; leave empty to include all agents',
      ...
      quickStartButton: 'Start Discussion',
      quickStartTitle: 'Start Free Discussion',
      quickStartGoal: 'Discussion Goal',
      quickStartGoalPlaceholder: 'Describe the problem you want the agents in the room to discuss and solve…',
      quickStartParticipants: 'Participating Agents',
      quickStartHint: 'Tip: you can also send /discuss <goal> [{\'@\'}member] directly in the input box',
      quickStartStart: 'Start',
      managerOnly: 'Only the room owner can start a discussion',
      attachments: 'Discussion Files',
      pickAttachments: 'Pick files',
      attachmentsHint: 'Attachment file names are written into the discussion goal so agents know what to read',
      ...
      downloadDuringActive: 'Discussion is running; download becomes available after it ends',
      downloadFailed: 'Failed to download report',
      docTitle: 'Group Chat Discussion Report',
      docMetaLabel: 'Discussion Info',
      docStatusLabel: 'End Status',
      docRoundsLabel: 'Rounds Completed',
      docAgentsLabel: 'Participating Agents',
      docJudgeLabel: 'Judge Notes per Round',
      docReportLabel: 'Consensus Report',
      docRoundLabel: 'Round {round}',
      docStalledLabel: 'Stalled',
      docProgressLabel: 'Progress',
      docAssessmentLabel: 'Assessment',
      docSuggestionLabel: 'Suggestion',
      docGeneratedBy: 'Auto-generated by Hermes Studio group discussion',
      docJudgeMissingLabel: 'Judge assessments are missing for this discussion',
      status: {
    ...
    document: {
      ...
      desc: 'Upload a large file (.txt/.md/.docx, up to 100MB) and multiple agents will read it in parallel chunks and produce a structured report (clause matrix + risk list + conflict list + action items).',
      upload: 'Upload Document',
      uploadHint: 'Supports .txt / .md / .docx; PDF text extraction is not supported yet',
      uploaded: 'Document uploaded, chunking started',
      uploadFailed: 'Document upload failed',
      chunks: 'chunks',
      active: 'Processing',
      start: 'Start Reading',
      startFailed: 'Failed to start reading',
      started: 'Reading started',
      needsAgents: 'Add agents to the room first',
      agentsPlaceholder: 'Select agents to read (default: all)',
      progress: 'Reading {done}/{total} chunks',
      failedHint: 'Processing failed; re-upload or retry later',
      status: {
        uploaded: 'Uploaded',
        chunked: 'Ready',
        reading: 'Reading',
  ...
  changelog: {
    ...
    new_0_7_6_1_4: 'ASR backend processes now auto-restart after unexpected crashes (exponential backoff, up to 5 attempts); main and diarize processes are both health-checked — meetings no longer silently die.',
    new_0_7_6_1_5: 'API keys now written to DATA_DIR (never the install directory); IDB audio stored as Blob (no more base64) saves 33% storage; audio upload capped at 200 MB.',
    ...
    new_0_6_21_7: 'Chat, group chat, and workflow headers are better aligned, BSL license scope is clearer, the /learn integration plan is documented, and unused Hermes proxy code was removed',
    ...
    new_0_6_20_6: 'ESP32 details were polished with updated tutorial links and a Windows-compatible flowing badge animation',
  ...
  modelGuide: {
    ...
    steps: {
      welcome: {
        title: 'Models are already connected',
        description: 'After signing in with WeChat, we automatically bound and enabled a model API for you. No manual key entry is needed — you can start chatting right away.',
        hint: 'A usable model was automatically selected as the default.',
      },
      settings: {
        title: 'View your connected models',
        description: 'Open the model settings page to see the automatically connected provider and its available models.',
        hint: 'If the list is empty, check your token platform subscription or re-scan with WeChat.',
      },
      addProvider: {
        title: 'Add more providers if you need them',
        description: 'To connect other model platforms, go to the models page to add a provider or switch the integration mode.',
        hint: 'WeChat login already connects the default provider; add others as needed.',
      },
      providerList: {
        title: 'Confirm the provider is available',
        description: 'The provider list should show the automatically connected available models. Refresh the model cache if necessary.',
        hint: 'If the list is empty, check your API key, network, and billing status.',
      },
      complete: {
        title: 'Finish and start chatting',
        description: 'The automatically configured model provider is ready, so you can finish the guide and start chatting immediately.',
  ...
  experts: {
    ...
    noLatestVersion: 'No published version',
    ...
    confirmUninstall: 'Uninstall this expert and remove related local profiles?',
    installedSuccess: 'Installed {n} expert profile(s), {failed} failed',
    upgradeSuccess: 'Upgraded {n} profile(s)',
    upgradedSuccess: 'Upgraded {n} profile(s)',
    uninstalledSuccess: 'Uninstalled',
    installFailed: 'Install failed',
  ...
  usb: {
    ...
    page: {
      title: 'USB Devices',
      subtitle: 'Browse mounted USB storage and preview files safely.',
      refresh: 'Refresh',
      empty: 'No USB storage devices are currently available.',
      loadFailed: 'Failed to load USB data',
      ...
      unreadCount: '{count} unread events',
      selectDevice: 'Select a USB device to browse files.',
      capacity: 'Capacity',
      loading: 'Loading...',
      copyPath: 'Copy Path',
      readWithAgent: 'Read With Agent',
      download: 'Download',
      name: 'Name',
      type: 'Type',
      size: 'Size',
      ...
      browser: {
        ...
        folder: 'Folder',
        file: 'File',
        selectFile: 'Select a file to view details or preview.',
        noPreview: 'Preview is not available for this file type.',
      },
      agent: {
        noActiveSession: 'No active Hermes session. Open a Hermes chat session first.',
        unsupportedSession: 'The current active session cannot be used for USB reading.',
        usingSession: 'Current Hermes session: {session}',
        copying: 'Copying the USB file into the active session workspace...',
        starting: 'Starting Agent reading in the active session...',
        started: 'Agent reading started in session: {session}',
    ...
    explorer: {
      ...
      toolbar: {
        ...
        viewIcons: 'Icon view',
        viewList: 'List view',
        addressBarPlaceholder: 'Enter a path',
      },
      breadcrumb: {
        root: 'This device',
        addressBarHint: 'Press Enter to navigate',
      },
      tree: {
        title: 'Folders',
        empty: 'No folders',
      ...
      nav: {
        backDisabledHint: 'No previous folder',
        forwardDisabledHint: 'No next folder',
        upDisabledHint: 'Already at root',
      },
      errors: {
        ...
        downloadFailed: 'Failed to download file',
        copyFailed: 'Failed to copy path',
        searchFailed: 'Search encountered an error',
      },
    },
  },
  meeting: {
    ...
    ossConfigHint: 'Configuring Alibaba Cloud OSS enables chunked real-time speaker diarization (without OSS, the WebSocket fallback mode is used, returning transcription only after recording stops).',
    ossBucket: 'OSS Bucket',
    ossBucketPlaceholder: 'Enter OSS bucket name',
    ossAccessKeyId: 'OSS Access Key ID',
    ossAccessKeyIdPlaceholder: 'Enter OSS Access Key ID',
    ossAccessKeySecret: 'OSS Access Key Secret',
    ossAccessKeySecretPlaceholder: 'Enter OSS Access Key Secret',
    ...
    wizardStepAsr: 'Speech recognition',
    wizardStepLlm: 'AI analysis',
    wizardStepReview: 'Review',
    wizardNext: 'Next',
    wizardBack: 'Back',
    wizardRestart: 'Reconfigure',
    llmOptionalHint: 'AI analysis (auto meeting minutes, key points, action items) uses the default Hermes Agent directly — no separate LLM config needed. Skip if you only want to record audio.',
    llmApiKey: 'LLM API Key',
    llmApiKeyPlaceholder: 'Enter LLM API Key (DeepSeek / OpenAI / etc.)',
    llmBaseUrl: 'LLM Base URL',
    llmBaseUrlPlaceholder: 'https://api.deepseek.com',
    llmModel: 'LLM Model',
    llmModelPlaceholder: 'deepseek-chat',
    wizardWarnMissingAsr: 'DashScope API Key not configured; speech recognition will not work.',
    wizardWarnMissingLlm: 'Custom LLM not configured. Meeting can be recorded, but the auto analysis report will not be generated; go back and choose "Hermes Agent" instead.',
    asrModel: 'Recognition Model',
    selectAsrModel: 'Select speech recognition model',
    asrModelHint: 'Select the model for speaker diarization, Fun-ASR is the next-generation model',
    asrModelParaformerDesc: 'Classic model, stable and reliable',
    asrModelFunAsrDesc: 'Next-generation model, supports more dialects and hot words (Recommended)',
    asrModelFunAsrMtlDesc: 'Multilingual model, supports more languages',
    asrModelMinimaxAsr10Desc: 'MiniMax standard speech-to-text model (default)',
    asrModelMinimaxSpeech01Desc: 'speech-01 alias (currently the same as asr-1.0 on the official API)',
    asrProvider: 'ASR provider',
    asrProviderDashscope: 'DashScope (Qwen)',
    asrProviderDashscopeDesc: 'Alibaba Bailian Paraformer / Fun-ASR streaming recognition (recommended)',
    asrProviderMinimax: 'MiniMax',
    asrProviderMinimaxDesc: 'MiniMax Speech-to-Text REST API; multilingual with optional speaker diarization',
    minimaxApiKey: 'MiniMax API Key',
    minimaxApiKeyHint: 'MiniMax interface key, get one at platform.minimax.cn.',
    minimaxApiKeyPlaceholder: 'Enter MiniMax API Key',
    wizardWarnMissingMinimax: 'MiniMax API key is missing — the MiniMax ASR provider cannot run.',
    analysisMode: 'Analysis Mode',
    hermesAgent: 'Hermes Agent',
    hermesAgentDesc: 'Directly invoke the Hermes Agent to generate meeting minutes, key points and action items — no separate LLM config needed',
    customModel: 'Custom Model',
    customModelDesc: 'Enter LLM API Key, Base URL and model to analyze with a custom model',
    selectProfile: 'Select Agent Profile',
    selectProfilePlaceholder: 'Select Hermes Agent profile',
    selectProvider: 'Select Provider',
    selectProviderPlaceholder: 'Select AI provider',
    selectModel: 'Select Model',
    selectModelPlaceholder: 'Select AI model',
    diarize: 'Speaker Diarization',
    diarizeHint: 'Enable to identify different speakers',
    // Create-meeting capture mode + whole-file transcription (2026-02)
    createTabRealtime: 'Realtime voice',
    createTabFile: 'Direct audio transcription',
    directTranscribe: 'Direct audio transcription',
    directTranscribeHint: 'Upload a whole recording; transcription starts right after the meeting is created (no microphone).',
    directEngine: 'Recognition engine',
    directEngineMinimaxDesc: 'MiniMax speech-to-text, supports speaker diarization; audio over 8 minutes is split automatically',
    directEngineQwenDesc: 'Alibaba Cloud Model Studio sync endpoint, up to 5 minutes and no speaker diarization',
    directDiarize: 'Separate speakers',
    directDiarizeHint: 'Label each segment with its speaker; you can rename speakers in the transcript',
    directDiarizeUnsupported: 'The Qwen engine does not support speaker diarization — choose MiniMax to separate speakers',
    directAudioFile: 'Audio file',
    directSelectFile: 'Choose audio file',
    directNoFile: 'No file selected',
    directQwenLengthHint: 'The Qwen engine uses a synchronous endpoint limited to 5 minutes; use MiniMax for longer audio',
    directTranscribing: 'Transcribing audio…',
    directTranscribeDone: 'Audio transcription finished',
    directTranscribeFailed: 'Audio transcription failed',
    diarizeAction: 'Separate speakers',
    diarizeActionHint: 'Send the whole recording to the ASR again and label the transcript with speakers',
    diarizeDialogTitle: 'Separate speakers',
    diarizeEngine: 'Recognition engine',
    diarizeStart: 'Start',
    diarizeQwenNeedsOss: 'Qwen speaker separation uses the Alibaba Cloud async file API, which only accepts publicly reachable audio URLs — an OSS bucket is required as the intermediary.',
    diarizeQwenOssRequired: 'Fill in the OSS bucket / AccessKey ID / AccessKey Secret to continue, or switch to the MiniMax engine.',
    ...
    diarizeNoNewSentences: 'The result matches the existing transcript; nothing new was added',
    saveMode: 'Save Mode',
    saveModeHint: 'Only run diarization, save 50% tokens (no real-time text)',
    normalMode: 'Normal Mode',
    normalModeHint: 'Real-time ASR + Diarization, better experience but double tokens',
    speakerCount: 'Speaker Count',
    speakerCountAuto: 'Auto Detect',
    clear: 'Clear',
    clearHint: 'Clear all transcript content',
    connecting: 'Connecting...',
    recording: 'Recording...',
    idle: 'Ready',
    emptyState: 'Click the button below to start recording',
    partial: 'Recognizing',
    stop: 'Stop Recording',
    ...
    report: 'Meeting Analysis Report',
    analysisEmpty: 'After starting recording, AI will automatically analyze meeting content',
    analysisStartError: 'Failed to start analysis',
    showPanel: 'Show Analysis Panel',
    hidePanel: 'Hide Analysis Panel',
    downloadAudio: 'Download Audio',
    downloadTranscript: 'Download Transcript',
    exportTranscript: 'Export Meeting Text',
    exportTranscriptHint: 'Download a well-formatted Markdown file with meeting info, speakers, timestamped transcript, full text, and AI analysis details',
    downloadReport: 'Download Report',
    downloadJson: 'Download JSON',
    downloads: 'Downloads',
    noTranscript: 'No transcript content to analyze',
    analysisError: 'Analysis failed, please try again',
    renameSpeaker: 'Rename Speaker',
    speakerPlaceholder: 'Enter speaker name',
    clickToJump: 'Click to jump to playback position',
    startingASRService: 'Starting ASR service...',
    asrServiceStartError: 'Failed to start ASR service',
    asrServiceRunning: 'ASR service is running',
    asrServiceStopped: 'ASR service stopped',
    // Agent related
    agentConfig: 'Agent Configuration',
    agentType: 'Agent Type',
    selectAgentType: 'Select Agent Type',
    agentTypeHermesDesc: 'Use Hermes Agent for intelligent analysis',
    agentTypeClaudeCodeDesc: 'Use Claude Code for deep analysis',
    agentTypeCodexDesc: 'Use OpenAI Codex for analysis',
    codingAgentMode: 'Runtime Mode',
    codingAgentModeScoped: 'Scoped Mode',
    codingAgentModeScopedDesc: 'Use models configured in Web UI',
    codingAgentModeGlobal: 'Global Mode',
    codingAgentModeGlobalDesc: 'Use Agent native CLI configuration',
    agentChat: 'Agent Chat',
    showAgentChat: 'Show Agent Chat',
    showAnalysis: 'Show Analysis',
    agentEmpty: 'Start conversation with Agent',
    agentEmptyHint: 'Click "Start Analysis" or type a message',
    agentInputPlaceholder: 'Type a message...',
    agentThinking: 'Agent is thinking...',
    startAnalysisHint: 'Auto-send transcript to Agent for analysis',
    analysisHint: 'Click "Analyze Now" to let AI generate the meeting report',
    correctTranscript: 'Correct Transcript',
    correctTranscriptHint: 'Use AI to correct typos in transcript',
    generateReport: 'Generate Report',
    generateReportHint: 'Call Agent to generate HTML analysis report',
    abort: 'Abort',
    agentErrorTitle: 'Agent runtime error',
    clearChat: 'Clear Chat',
    thinking: 'Thinking',
    agentAnalysis: 'Agent Analysis Process',
    analyzing: 'Analyzing...',
    toolFailed: 'Failed',
    ...
    // Legal communication scene (legal)
    // Customer interview scene (interview)
    interview: {
      sceneLabel: 'Interview',
      stripHint: 'Discovery · Follow-up nudges',
      connected: 'AI connected',
      analyzing: 'AI analyzing…',
      notConnected: 'AI not connected (auto-connects on recording)',
      ...
      emptyQuotes: 'No key quotes yet.',
      followUps: 'Probe suggestions',
      followUpsDesc: 'AI-suggested next questions based on customer answers (max 2 per round, latest round only).',
      emptyFollowUps: 'No probe suggestions yet.',
      typeNeed: 'Need',
      typePain: 'Pain',
      typeOpportunity: 'Opportunity',
      typeCompetitor: 'Competitor',
      reportTitle: 'Interview report',
      generateReport: 'Generate interview report',
      exporting: 'Exporting…',
      exportWord: 'Export as Word (.docx)',
      exportHtml: 'Export as HTML',
      exportMarkdown: 'Export as Markdown',      generating: 'Generating report…',
    },
    legal: {
      sceneLabel: 'Legal',
      stripHint: 'Clause review · Risk alerts',
      connected: 'AI connected',
      analyzing: 'AI analyzing…',
      notConnected: 'AI not connected (auto-connects on recording)',
      analyzeNow: 'Analyze now',
      riskRadar: 'Risk radar',
      riskRadarDesc: 'Real-time legal risk detection: sorted by severity, with source quotes and statute hints.',
      highRiskCount: '⚠ {n} high-risk',
      riskTotal: '{n} risks',
      emptyRisks: 'No risk alerts yet. AI analyzes risk signals once recording starts.',
      positions: 'Positions',
      emptyPositions: 'No party positions recorded yet.',
      lawRefs: 'Statutes & references',
      emptyLawRefs: 'No statute references yet.',
      needsVerify: 'Needs verification',
      verified: 'Verified',
      verifyNote: 'Statute content is generated from AI knowledge — do not cite before verification.',
      lawHint: 'Re: ',
      reportTitle: 'Legal communication report',
      generateReport: 'Generate legal report',
      exporting: 'Exporting…',
      exportWord: 'Export as Word (.docx)',
      exportHtml: 'Export as HTML',
    ...
    speechEval: {
      ...
      topImprovement: 'The single most important improvement',
      topics: 'Topics',
      newPoints: 'New feedback',
      scoreContent: 'Content',
      scoreStructure: 'Structure',
      scoreLanguage: 'Language',
      scoreTimeControl: 'Time control',
      scoreOverall: 'Overall',
      grammarIssues: 'Grammar issues',
      wotdUsedFlag: 'Word of the Day used ✓',
      goldenQuotes: 'Golden quotes',
      goldenQuotesDesc: 'A golden quote = one sentence with a viewpoint, infectious, memorable and quotable on its own.',
      aiGoldenQuotes: 'AI golden quotes',
      aiGrammarIssues: 'AI grammar issues',
      emptyFillers: 'No filler words yet. They will appear in real time once AI detects them.',
      fillerBySpeaker: 'Fillers (by speaker)',
      fillerThresholdNote: 'Lenient rule: fewer than 10 fillers per 3 minutes is not treated as an issue.',
      unknownSpeaker: 'Unmarked',
      timer: 'Timer',
      timerDesc: 'Strictly control the speaking time of each segment. Use red, yellow and green cards to signal time to speakers, and report everyone\'s time usage at the end of the meeting to build time awareness.',
      settings: 'Settings',
      settingsTitle: 'Timer Settings',
      durationLabel: 'Standard duration per segment (seconds)',
      yellowLabel: 'Yellow card trigger (seconds remaining)',
      redLabel: 'Red card trigger (seconds remaining)',
      greenCard: 'Green',
      yellowCard: 'Yellow',
      redCard: 'Red',
      start: 'Start',
      ...
      transitionHint: 'Now timing the host transition / interlude. Records are tagged "Transition" so the report can judge whether transitions drag.',
      recordTransition: 'Record transition',
      transitionLabel: 'Transition',
      timeRecords: 'Time usage records',
      emptyRecords: 'No time records yet',
      speakerDuration: 'Talk time by speaker',
      emptySpeakerDurations: 'No talk-time data yet',
      voiceAlert: 'Voice alerts',
      voiceAlertOn: '🔊 Voice alerts on',
      voiceAlertOff: '🔊 Voice alerts off',
      voiceAlertDesc: 'Voice announcements for yellow card / red card / time\'s up',
      ahCounter: 'Ah-Counter',
      ahCounterDesc: 'AI identifies filler words or verbal tics in the speech in real time (e.g. "uh", "um", "you know"), helping everyone break bad speaking habits.',
      fillerTotal: 'Total filler words',
      times: 'times',
      addFiller: 'Add filler word…',
      add: 'Add',
      grammarian: 'Grammarian',
      grammarianDesc: 'AI detects "Word of the Day" usage, golden quotes and grammar issues in real time, then delivers a summary report at the end.',
      wordOfTheDay: 'Word of the Day',
      used: 'Used',
      goodPhrases: 'Golden quotes (manual)',
      grammarNotes: 'Grammar errors',
      addNotePlaceholder: 'Type something…',
      bodyLanguage: 'Body language & stage presence',
      bodyLanguageDesc: 'AI cannot see the video. Record your observations of expressions, gestures and posture here, and the report will combine them into coaching feedback.',
      bodyNotesPlaceholder: 'e.g. natural gestures, keeps looking at notes, steady stance…',
      addBodyNote: 'Add observation',
      ...
      exportMarkdown: 'Export as Markdown',
      exporting: 'Exporting…',
      practiceHint: 'Deliberate practice · watch pacing & delivery',
      presetsLabel: 'Segment presets (Toastmasters)',
      preset_tableTopics: 'Table Topics 2m',
      preset_prepared: 'Prepared 5-7m',
    ...
    triggerModeSentences: 'By Sentence Count',
    triggerModeTime: 'By Time Interval',
    triggerModeBoth: 'Both (trigger on either condition)',
    intervalSentences: 'Trigger every N sentences',
    intervalSentencesHint: 'Auto-trigger analysis every N sentences',
    intervalSeconds: 'Time Interval',
    intervalSecondsHint: 'Auto-trigger analysis every N seconds',
    sentencesUnit: 'sentences',
    secondsUnit: 'seconds',
    // New analysis result categories
    decisions: 'Decisions',
    risks: 'Risks',
    learnings: 'Learnings',
    feedback: 'Feedback',
    ...
    noReportYet: 'No report yet. Run analysis first.',
    ...
    realtime: {
      ...
      instructionsPlaceholder: 'Describe the persona and style for the assistant',
