export default {
  ...
  mcp: {
    ...
    testOk: 'Test OK ‚Ä?{count} tools available',
  ...
  chat: {
    ...
    slashCommands: {
      ...
      clearHistory: 'Delete this session‚Äôs stored message history',
  ...
  models: {
    ...
    copilotDeleteHintGhCli: 'Copilot will be hidden from Hermes. Your gh CLI login is not affected ‚Ä?`gh auth status` will still show you signed in.',
  ...
  settings: {
    ...
    voice: {
      ...
      fetchingModels: 'Fetching models‚Ä?,
      ...
      sttRecordingHint: 'Recording‚Ä?click Stop to transcribe.',
      ...
      ttsTestSaving: 'Saving TTS settings before audition‚Ä?,
      ...
      sttTestRecording: 'Recording test sample‚Ä?click Stop and transcribe when done.',
      sttTestTranscribing: 'Transcribing test sample‚Ä?,
      sttTestEmpty: 'No audio was captured for the STT test.',
      sttTestSucceeded: 'STT test succeeded.',
      sttTestFailed: 'STT test failed: {error} ‚Ä?{hint}',
      ...
      // Custom endpoint
      customHint: 'Use any OpenAI-compatible TTS API ‚Ä?works with GPT-SoVITS, CosyVoice, etc.',
      customUrl: 'API URL',
      ...
      mimoHint: 'Xiaomi MiMo TTS ‚Ä?supports preset voices, voice design, and voice clone modes',
      mimoApiKey: 'API Key',
      ...
      mimoStylePromptHint: 'Optional ‚Ä?describe the speaking style in natural language',
  ...
  githubPreview: {
    ...
    start: "Start Preview",
    stop: "Stop",
    note: "Preview code is stored under the Web UI data home. Production remains on port 6060; preview development runs on frontend 8651 and backend 8650.",
    path: "Preview Path",
