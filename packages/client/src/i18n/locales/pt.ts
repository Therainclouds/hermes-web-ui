????????????export default {
  ...
  mcp: {
    ...
    invalidConfig: 'Configura??o inválida',
    invalidServerConfig: 'Configura??o do servidor inválida',
    ...
    toolsClearSelection: 'Limpar sele??o',
    toolsExcludeAll: 'Excluir tudo',
    toolsClearExcluded: 'Limpar exclus?es',
  },
  ...
  sidebar: {
    ...
    versionManagement: 'Gerenciamento de vers?es',
    kanban: 'Kanban',
    groupTools: 'Ferramentas',
    groupToolsShort: "Ferr.",
    codingAgents: "Agentes de código",
    versionPreview: "Prévia de vers?o",
  ...
  runtimeVersions: {
    title: 'Gerenciamento de vers?es',
    runtimeTitle: 'Hermes Runtime',
    webUiTitle: 'Web UI',
    platform: 'Plataforma',
    currentWebUi: 'Web UI atual',
    activeVersion: 'Vers?o ativa',
    active: 'Ativa',
    installed: 'Instalada',
    download: 'Baixar',
    ...
    github: 'GitHub',
    cf: 'Cloudflare',
    useVersion: 'Usar na próxima reinicializa??o',
    ...
    refresh: 'Atualizar',
    noVersions: 'Nenhuma vers?o disponível',
    remoteLoadFailed: 'Falha ao carregar vers?es remotas',
    downloadTasks: 'Tarefas de download',
    downloadStarted: 'Download iniciado',
    activateSuccess: 'Sele??o de vers?o salva. Reinicie o Hermes Studio para usá-la.',
    jobStatus: {
      queued: 'Na fila',
      running: 'Em execu??o',
      completed: 'Concluída',
  ...
  devices: {
    ...
    duplicateRequest: 'Já existe uma solicita??o de pareamento pendente',
    ...
    unprocessed: 'N?o processado',
    deleteHistory: 'Excluir registro',
    deleteHistoryConfirm: 'Excluir este registro de solicita??o e revogar o acesso de conex?o deste dispositivo?',
    requests: 'Solicita??es',
    requestsWithCount: 'Solicita??es ({count})',
    noRequests: 'Nenhuma solicita??o',
  ...
  performance: {
    title: 'Desempenho',
    subtitle: 'Monitore recursos do sistema, Bridge Broker, Workers e sess?es ativas',
    refresh: 'Atualizar',
    autoRefreshOn: 'Atualiza??o automática',
    autoRefreshOff: 'Atualiza??o manual',
    loadFailed: 'Falha ao carregar métricas de desempenho',
    systemCpu: 'CPU do sistema',
    systemMemory: 'Memória do sistema',
    activeSessions: 'Sess?es ativas',
    runningSessions: 'Em execu??o {count}',
    workers: 'Workers',
    ...
    memory: 'Memória',
    sessions: 'Sess?es',
    runningActiveSessions: 'Em execu??o / Ativas',
    lastUsed: 'último uso',
    status: 'Status',
    noWorkers: 'Nenhum Worker',
    sessionsByProfile: 'Sess?es por Profile',
    noActiveSessions: 'Nenhuma sess?o ativa',
  },

  // Gaveta
  drawer: {
    terminal: 'Terminal',
    files: 'Espa?o de trabalho',
  },
  ...
  chat: {
    ...
    contextEditHint: 'Valores comuns: 256k (Hermes padr?o), 128k (GPT-4), 32k (GPT-3.5)',
    ...
    contextEditFailed: 'Falha na atualiza??o',
    ...
    outlineTitle: 'Esbo?o da conversa',
    ...
    slashCommands: {
      usage: 'Calcular o uso da sess?o atual',
      status: 'Mostrar status da sess?o e fila',
      abort: 'Parar a execu??o ativa do Bridge',
      queue: 'Enfileirar uma mensagem após a execu??o ativa',
      plan: 'Escrever um plano de implementa??o em Markdown',
      ...
      clear: 'Limpar a visualiza??o atual',
      clearHistory: 'Excluir o histórico de mensagens salvo desta sess?o',
      title: 'Renomear esta sess?o',
      compress: 'Executar compress?o de contexto quando ocioso',
      steer: 'Enviar texto de orienta??o para a execu??o ativa do Bridge',
      destroy: 'Liberar o Bridge Agent desta sess?o',
      reloadMcp: 'Recarregar servidores MCP',
      reloadSkills: 'Recarregar comandos de skills',
    },
    attachFiles: 'Anexar arquivos',
    reasoningEffort: {
      tooltip: 'Esfor?o de raciocínio',
      defaultLabel: 'Padr?o',
      options: {
        default: 'Padr?o (config.yaml)',
        none: 'Nenhum',
        minimal: 'Mínimo',
        low: 'Baixo',
        medium: 'Médio',
    ...
    sessions: 'Sessoes',
    webUiSessions: 'Sess?es',
    allProfiles: 'Todos os perfis',
    profileMissingModelsTip: 'O perfil "{profile}" n?o tem provider ou modelo disponível para esta sess?o',
    sessionScopeHint: 'O chat mostra apenas sess?es da Web UI/API Server. Sess?es de CLI, Telegram, Discord, Cron e outros canais s?o somente leitura no Histórico.',
    openHistory: 'Abrir histórico',
    hermesHistory: 'Histórico QuantHermes',
    historyScopeHint: 'Sess?es do histórico QuantHermes somente leitura, agrupadas por origem.',
    noSessions: 'Sem sessoes',
    newChat: 'Novo chat',
    agent: 'Agent',
    approvalKicker: 'Permiss?o do terminal',
    approvalTitle: 'Revisar comando antes de executar',
    approvalAgree: 'Concordar',
    approvalAllowOnce: 'Permitir uma vez',
    approvalAllowSession: 'Permitir sess?o',
    ...
    toggleBatchMode: 'Sele??o em lote',
    selectAll: 'Selecionar tudo',
    confirmBatchDelete: 'Excluir {count} sess?es selecionadas?',
    batchDeleteSuccess: '{count} sess?es excluídas',
    batchDeletePartial: '{failed} sess?es falharam ao excluir',
    batchDeleteFailed: 'Falha na exclus?o em lote',
    importToWebUi: 'Importar para Web UI',
    importSessionSuccess: 'Sess?o importada para Web UI',
    importSessionAlreadyExists: 'A sess?o já existe no Web UI',
    importSessionFailed: 'Falha ao importar sess?o',
    ...
    copySessionLink: 'Copiar link da sess?o',
    openSessionInNewTab: 'Abrir em nova aba',
    sessionLinkCopied: 'Session link copied',
    copySessionId: 'Copiar ID da sess?o',
    export: 'Exportar',
    exportFull: 'Exporta??o completa (JSON)',
    exportCompressed: 'Exporta??o comprimida (TXT)',
    exportCompressing: 'Comprimindo contexto, aguarde...',
    exportSuccess: 'Sess?o exportada',
    ...
    executionDuration: 'Tempo de execu??o',    thinkingLabel: 'Raciocínio',
    ...
    stopSpeech: 'Parar',
    speechNotSupported: 'Reprodu??o de voz n?o suportada neste navegador',
    searchEnterHint: 'Enter para abrir · Esc para fechar',
    searchHint: 'Cmd/Ctrl+K',
    searchScope: 'Escopo da busca: apenas banco local de sess?es da Web UI; sess?es históricas Hermes somente leitura n?o s?o incluídas.',
    searchFailed: 'Falha ao pesquisar sess?es',
    searchNoSnippet: 'Nenhum resumo disponível',
    searchNoResults: 'Nenhuma sess?o corresponde à busca',
    searchRecent: 'Sess?o recente',
    searchEmpty: 'Sess?es recentes',
    searchPlaceholder: 'Pesquisar sess?es...',
    searchSubtitle: 'Pesquisar por título ou conteúdo da mensagem',
    searchTitle: 'Pesquisar sess?es',
...
jobTriggered: 'Job acionado',
  ...
  skills: {
    ...
    delete: 'Excluir',
    deleteConfirm: 'Excluir a habilidade "{name}"? Esta a??o n?o pode ser desfeita.',
    ...
    importInvalidFile: 'Apenas arquivos .zip s?o suportados',
    ...
    externalDirs: {
      ...
      missing: 'Caminho n?o encontrado',
      notDir: 'N?o é um diretório',
    ...
    reloadHint: 'Sess?es ativas: execute /reload-skills; novas sess?es carregam automaticamente.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Atualizar',
    notice: 'Inventário somente leitura dos manifests de plugins QuantHermes detectáveis. Os metadados de descoberta s?o lidos sem carregar código de plugin. No v1, a??es de gerenciamento ficam na CLI; mudan?as entram em vigor em novas sess?es QuantHermes.',
    loadFailed: 'Falha ao carregar plugins',
    commandCopied: 'Comando copiado',
    searchPlaceholder: 'Buscar key, nome, descri??o, caminho...',
    source: 'Origem',
    kind: 'Tipo',
    statusTitle: 'Status',
    ...
    statusLabel: {
      enabled: 'Ativado por configura??o',
      'auto-active': 'Autoativo',
      inactive: 'Inativo',
      disabled: 'Desativado',
      'provider-managed': 'Gerenciado por provider',
  ...
  models: {
    ...
    codexWaiting: 'Digite este código na página de autoriza??o para fazer login:',
    codexCopyCode: 'Código copiado',
    codexOpenLink: 'Abrir página de autoriza??o',
    codexApproved: 'Login bem-sucedido',
    codexExpired: 'A autoriza??o expirou. Por favor, tente novamente.',
    nousLoginTitle: 'Login do Nous Portal',
    nousWaiting: 'Insira este código na página de autoriza??o:',
    nousCopyCode: 'Código copiado',
    nousOpenLink: 'Abrir página de autoriza??o',
    nousApproved: 'Login bem-sucedido',
    nousDenied: 'Autoriza??o negada',
    nousExpired: 'Autoriza??o expirada',
    copilotLoginTitle: 'Login do GitHub Copilot',
    copilotWaiting: 'Abra o GitHub e insira o código do dispositivo abaixo para autorizar. A janela fechará automaticamente após a aprova??o.',
    copilotCopyCode: 'Código copiado',
    copilotOpenLink: 'Abrir a página de autoriza??o do GitHub',
    copilotApproved: 'Login bem-sucedido!',
    copilotDenied: 'Autoriza??o negada.',
    copilotExpired: 'O link de autoriza??o expirou. Tente novamente.',
    ...
    copilotAddSourceAppsJson: 'Origem: extens?o Copilot do VS Code (apps.json)',
    copilotDeleteHintEnv: 'Isto irá limpar o COPILOT_GITHUB_TOKEN em ~/.hermes/.env. Outras ferramentas n?o s?o afetadas.',
    copilotDeleteHintGhCli: 'O Copilot ficará oculto no QuantHermes. Sua sess?o no gh CLI n?o é afetada — `gh auth status` continuará indicando que está conectado.',
    copilotDeleteHintAppsJson: 'O Copilot ficará oculto no QuantHermes. A extens?o Copilot do VS Code continuará conectada.',
    customBadge: 'PERSONALIZADO',
    previewBadge: 'PRéVIA',
    disabledBadge: 'INDISPONíVEL',
    disabledTooltip: "Este modelo n?o está disponível para sua conta.",
    customModelPlaceholder: 'ID de modelo n?o listado',
    customModelHint: 'Para modelos compatíveis com o provedor que a API n?o retorna; n?o é uma renomea??o de exibi??o. Enter para carregar.',
    noProviders: 'Nenhum provedor encontrado. Adicione um provedor personalizado para comecar.',
    clearVisibleModels: 'Limpar sele??o',
    auxiliaryTitle: 'Modelos auxiliares',
    auxiliarySubtitle: 'Substitui??es de modelo para tarefas auxiliares como compress?o, vis?o, aprova??es, MCP e manuten??o em segundo plano.',
    ...
    auxiliaryActions: 'A??es',
    auxiliaryDefault: 'Padr?o',
    ...
    auxiliaryTaskCompression: 'Compress?o',
    auxiliaryTaskVision: 'Vis?o',
    auxiliaryTaskWebExtract: 'Extra??o web',
    auxiliaryTaskSkillsHub: 'Hub de habilidades',
    auxiliaryTaskApproval: 'Aprova??o',
    auxiliaryTaskMcp: 'MCP',
    auxiliaryTaskTitleGeneration: 'Gera??o de título',
    auxiliaryTaskTriageSpecifier: 'Especificador de triagem',
    auxiliaryTaskKanbanDecomposer: 'Decomposi??o Kanban',
    auxiliaryTaskProfileDescriber: 'Descri??o de perfil',
    auxiliaryTaskCurator: 'Curador',
    auxiliaryTaskSessionSearch: 'Busca de sess?es',
    auxiliaryTaskFlushMemories: 'Gravar memórias',
    currentDefault: 'Padr?o atual',
    defaultShort: 'Padr?o',
    builtIn: 'Integrado',
    ...
    xaiWaiting: 'Conclua a autoriza??o na página xAI aberta. A janela será fechada automaticamente após a aprova??o.',
    xaiOpenLink: 'Abrir página de autoriza??o xAI',
    xaiLoginTitle: 'Login OAuth xAI Grok',
    xaiExpired: 'O link de autoriza??o expirou. Tente novamente.',
    xaiCopyLink: 'Copiar link de autoriza??o',
    xaiApproved: 'Login concluído!',
    anthropicLoginTitle: 'Login OAuth Claude',
    anthropicWaiting: 'Conclua a autoriza??o no Claude e cole aqui o código retornado.',
    anthropicOpenLink: 'Abrir página de autoriza??o Claude',
    anthropicCopyLink: 'Copiar link de autoriza??o',
    anthropicCodePlaceholder: 'Cole o código de autoriza??o...',
    anthropicSubmitCode: 'Enviar código',
    anthropicApproved: 'Login concluído!',
    anthropicExpired: 'A autoriza??o expirou. Tente novamente.',
    geminiLoginTitle: 'Login OAuth Google Gemini',
    geminiWaiting: 'Conclua a autoriza??o na página Google aberta. A janela será fechada automaticamente.',
    geminiOpenLink: 'Abrir página de autoriza??o Google',
    geminiCopyLink: 'Copiar link de autoriza??o',
    geminiApproved: 'Login concluído!',
    geminiExpired: 'O link de autoriza??o expirou. Tente novamente.',
    ...
    visibilityHint: 'Afeta apenas o seletor de modelos e a página de modelos da Web UI. A configura??o provider/model da Hermes CLI n?o é alterada; as chamadas ainda usam o ID original do modelo.',
    showAllModels: 'Mostrar todos os modelos',
    searchPlaceholder: 'Pesquisar modelos...',
    removeCustomModel: 'Remover este modelo n?o listado',
  ...
  profiles: {
    ...
    cloneCleanupNotice: 'Ao clonar, as credenciais exclusivas de plataforma (Weixin / Telegram / Slack, etc.) s?o automaticamente ignoradas para evitar conflitos com o perfil de origem',
    ...
    avatar: {
      ...
      reset: 'Restaurar padr?o',
      hint: 'PNG, JPEG ou WebP, máximo 1 MB',
      invalidType: 'Escolha uma imagem PNG, JPEG ou WebP',
      tooLarge: 'A imagem do avatar n?o pode exceder 1 MB',
      saveSuccess: 'Avatar salvo',
      saveFailed: 'Falha ao salvar avatar',
      resetSuccess: 'Avatar padr?o restaurado',
      resetFailed: 'Falha ao restaurar avatar padr?o',
    },
    runtime: {
  ...
  settings: {
    ...
    gatewayAutoStart: {
      title: 'Inicializa??o automática do gateway',
      description: 'Controla quais gateways de perfis Hermes locais a Web UI inicia durante a inicializa??o. Isto é salvo na configura??o da Web UI, n?o no config.yaml do perfil.',
      ...
      includeHint: 'Nomes de perfil separados por vírgula. No modo de inclus?o, uma lista vazia n?o inicia nenhum.',
    ...
    session: {
      ...
      humanOnly: 'Mostrar apenas sess?es humanas',
      humanOnlyHint: 'Oculta por padr?o o ruído de subagentes e do monitor de sess?es',
      liveMonitorHumanOnly: 'Monitor ao vivo: mostrar apenas sess?es humanas',
      liveMonitorHumanOnlyHint: 'Oculta por padr?o o ruído de subagentes e do monitor de sess?es no monitor ao vivo',
    ...
    voice: {
      ...
      connectionStep: 'Conex?o',
      discoveryManualHint: 'Endpoint personalizado manual selecionado. A descoberta de modelos n?o está disponível; informe o nome do modelo manualmente.',
      discoveryCredentialHint: 'Informe Base URL e API key, depois conecte para buscar os modelos disponíveis.',
      discoveryNoAutoProbeHint: 'Nenhuma requisi??o é enviada durante a digita??o. Use Connect quando as credenciais estiverem prontas.',
      apiKeyConnectPlaceholder: 'Cole a API key para conectar; chaves armazenadas nunca s?o exibidas',
      ...
      discoveryFailedManualFallback: 'N?o foi possível buscar modelos. Você ainda pode informar o nome do modelo manualmente.',
      ...
      sttAudioTranscode: 'Transcodifica??o de áudio',
      ...
      mimoAuthMode: 'Modo de autentica??o',
      mimoAuthModeHint: 'Formato de cabe?alho esperado pelo endpoint MiMo selecionado',
      mimoAuthModeBearer: 'Token Bearer (Authorization)',
      mimoAuthModeApiKey: 'Cabe?alho API key (api-key)',
      mimoAuthModeBoth: 'Ambos os cabe?alhos',
      ...
      mimoVoiceDesignPrompt: 'Descri??o da voz',
  ...
  githubPreview: {
    ...
    stop: "Parar",
    note: "O código de prévia é armazenado no diretório de dados do Web UI. Produ??o permanece na porta 6060; a prévia usa frontend 8651 e backend 8650.",
    ...
    running: "Estado",
    notRunning: "N?o em execu??o",
    open: "Abrir prévia",
    log: "Caminho do log de a??es",
    logOutput: "Saída de logs",
    actionLog: "Log de a??es",
    devLog: "Log do servidor dev",
    yes: "Sim",
    no: "N?o",
    actionFailed: "A??o falhou",
    nodeEnvironmentMissing: "Node/npm n?o foi detectado. Instale o Node.js e tente novamente.",
  ...
  codingAgents: {
    ...
    notice: "Nem todos os provedores e modelos s?o compatíveis.",
    claudeDescription: "CLI da Anthropic para tarefas únicas em print mode e sess?es interativas de código.",
    ...
    refresh: "Atualizar",
    checking: "Verificando",
    installStatus: "Status da instala??o",
    installed: "Instalado",
    notInstalled: "N?o instalado",
    installRequired: "{agent} n?o está instalado. Instale antes de criar uma sess?o.",
    installNow: "Instalar",
    installing: "Instalando",
    installSuccess: "Instalado",
    installFailed: "Falha na instala??o",
    installFailedHermesHint: "A instala??o falhou. Pe?a ao Hermes para instalar para você.",
    ...
    deleteFailed: "Falha ao excluir",
    configFiles: "Arquivos de configura??o",
    profileScope: "Perfil",
    providerScope: "Provedor",
    providerPlaceholder: "ex.: custom:glm",
    modelScope: "Modelo",
    modelPlaceholder: "Selecionar modelo",
    launchModeScope: "Modo de inicializa??o",
    launchModeGlobal: "Configura??o global",
    ...
    reloadConfig: "Recarregar configura??o",
    configFileNotCreated: "N?o criado",
    configLoadFailed: "Falha ao ler arquivo de configura??o",
    ...
    launchPrepared: "Configura??o de inicializa??o preparada",
    launchPrepareFailed: "Falha ao preparar configura??o de inicializa??o",
    ...
    launchConfigDir: "Diretório de configura??o de inicializa??o",
    launchCommand: "Comando de inicializa??o",
    table: {
      tool: "Ferramenta",
      kind: "Etapa",
      command: "Comando",
  ...
  platform: {
    ...
    verificationToken: 'Token de verifica??o',
    verificationTokenHint: 'Token de verifica??o do Feishu',
    clientId: 'ID do cliente',
    clientIdHint: 'ID do cliente DingTalk',
    clientSecret: 'Segredo do cliente',
    clientSecretHint: 'Segredo do cliente DingTalk',
    cardTemplateId: 'ID do modelo de cart?o IA',
    cardTemplateIdHint: 'ID do modelo de cart?o IA do DingTalk; deixe vazio para desativar os cart?es IA',
    botId: 'ID do bot',
    ...
    qqQrScanHint: 'Escaneie o QR code com QQ ou abra o link no celular para concluir a vincula??o',
    qqMarkdownHint: 'Ativar mensagens em formato Markdown (alguns clientes podem n?o suportar)',
    ...
    qqAppId: 'App ID',
    allowedUsersHint: 'Lista de permiss?es de IDs de usuário ou OpenID, separados por vírgula',
    allowedUsers: 'Usuários permitidos',
    allowAllUsersHint: 'Permite mensagens de qualquer usuário; desative para usar a lista de permiss?es',
  ...
  terminal: {
    ...
    noSessions: 'Nenhuma sess?o de terminal',
  ...
  skillsUsage: {
    ...
    subtitle: 'Acompanhe carregamentos e edi??es de habilidades nas sess?es QuantHermes',
    refresh: 'Atualizar',
  ...
  groupChat: {
    ...
    clearContextConfirm: 'Limpar o contexto desta sala? Mensagens e snapshots de compacta??o ser?o removidos, mas agentes e membros ficam.',
    ...
    compressionSettings: 'Configura??o de compacta??o',
    triggerTokens: 'Tokens de acionamento',
    triggerTokensDesc: 'Limite de tokens para acionar a compacta??o',
    ...
    compressionConfig: 'Config. de compacta??o',
    compressNow: 'Compactar agora',
    compressingInProgress: 'Compacta??o em andamento',
    compressionSaved: 'Configura??o salva',
  },
  ...
  kanban: {
    ...
    form: {
      ...
      body: 'Descri??o',
      bodyPlaceholder: 'Descri??o da tarefa (opcional)',
    ...
    detail: {
      ...
      result: 'Resultado',
      highlights: 'Informa??es principais',
      sources: 'Fontes de dados',
      sessions: 'Sess?es relacionadas',
      sessionMessages: 'Mensagens da sess?o',
      noSessions: 'Nenhuma sess?o relacionada encontrada.',
    ...
    action: {
      ...
      unblock: 'Desbloquear',
      complete: 'Concluir',
      completeSummary: 'Resumo de conclus?o (opcional)',
      dispatch: 'Despachar',
      recoveryReason: 'Motivo de recupera??o (opcional)',
      reclaim: 'Recuperar',
      reassign: 'Reatribuir',
      specify: 'Especificar',
