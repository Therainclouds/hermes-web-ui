????????????export default {
  ...
  sidebar: {
    ...
    versionPreview: "Aper?u de version",
  ...
  runtimeVersions: {
    ...
    downloadTasks: 'Taches de téléchargement',
...
jobTriggered: 'Job declenche',
  ...
  models: {
    ...
    auxiliarySubtitle: 'Remplacements de modèle pour les taches secondaires comme la compression, la vision, les approbations, MCP et la maintenance en arrière-plan.',
    ...
    aliasHint: 'Modifie uniquement le nom affiché dans la Web UI. Hermes re?oit toujours l’ID de modèle d’origine.',
    aliasEdit: 'Renommer',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Contr?le les gateways de profils Hermes locaux que la Web UI démarre au lancement. Cette option est stockée dans la configuration Web UI, pas dans le config.yaml du profil.',
    ...
    voice: {
      ...
      storedApiKeysHint: 'Liste masquée des clés vocales stockées c?té serveur. Seuls l’usage et la source sont affichés; la key complète ne l’est jamais.',
  ...
  githubPreview: {
    ...
    start: "Démarrer l’aper?u",
    stop: "Arrêter",
    note: "Le code de prévisualisation est stocké dans le dossier de données Web UI. La production reste sur le port 6060 ; la prévisualisation utilise le frontend 8651 et le backend 8650.",
    path: "Chemin de prévisualisation",
    webuiHome: "Données de prévisualisation",
    currentTag: "Tag actuel",
    repoReady: "Dép?t prêt",
    dependencies: "Dépendances installées",
    running: "état",
    notRunning: "Arrêté",
    open: "Ouvrir l’aper?u",
  ...
  codingAgents: {
    ...
    claudeDescription: "CLI Anthropic pour les taches ponctuelles en print mode et les sessions de code interactives.",
    codexDescription: "CLI OpenAI et flux fournisseur Hermes openai-codex pour les taches de dép?t.",
    copyCommand: "Copier",
    commandCopied: "Commande copiée",
    ...
    notes: {
      ...
      claudeRun: "Print mode est le chemin le plus propre pour les taches ponctuelles pilotées par API.",
      codexRun: "Les taches ponctuelles Codex doivent s’exécuter dans un dép?t git.",
    },
  },
  ...
  kanban: {
    ...
    form: {
      title: 'Titre',
      titlePlaceholder: 'Titre de la tache',
      titleRequired: 'Le titre est requis',
      body: 'Description',
      bodyPlaceholder: 'Description de la tache (facultatif)',
    ...
    detail: {
      ...
      noLog: 'Aucun log trouvé pour cette tache.',
    ...
    message: {
      loadFailed: 'échec du chargement de la tache',
      taskCreated: 'Tache créée',
      taskAssigned: 'Tache assignée',
      taskBlocked: 'Tache bloquée',
      taskUnblocked: 'Tache débloquée',
      taskCompleted: 'Tache terminée',
      dispatchNudged: 'Dispatcher déclenché',
      commentAdded: 'Commentaire ajouté',
      taskReclaimed: 'Tache récupérée',
      taskReassigned: 'Tache réassignée',
      taskSpecified: 'Tache spécifiée',
    },
    stats: {
      total: 'Total',
      tasks: 'Taches',
